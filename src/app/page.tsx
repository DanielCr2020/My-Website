  ...
  return (
    <main className="main">
      ...
      <div className='description'>
        ...
        <p>
          Starting in the Fall of 2024, I am pursuing my graduate Computer Science education at Rutgers 
        ...
        <p>
          To learn more, feel free to check out the other pages by clicking the buttons on the top of the page.
